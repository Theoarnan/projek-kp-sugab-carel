    ...
    <div class="content-header">
        ...
        <div class="card card-info">
            ...
            <div class="card-footer">
                <a href="<?= site_url(array("Customer", "register")) ?>" class="btn btn-success "><i class="fas fa-folder-plus"></i>
                        ...
                        ?>
                            <tr>
                                ...
                                <td style="text-align:center">
                                    <a href="<?= site_url("Customer/update/$customer->id_kustomer") ?>" class="btn btn-sm btn-warning" data-title="Edit"><i class="fas fa-edit"></i></a>
                                    <a href="#" data-id="<?= $customer->id_kustomer ?>" id="delete_id" class="btn btn-sm btn-danger tombolHapus">
                                        <fas class="fas fa-trash"></fas>
                                    </a>
                                    <a href="<?= site_url('customer/print_customer/') . $customer->id_kustomer ?>" target="_blank" class="btn btn-sm btn-primary"><i class="fas fa-print"></i>
                            </a>
                                </td>
                            </tr>
                        <?php
            ...
            Swal.fire({
                ...
                preConfirm: function() {
                    return new Promise(function(resolve) {
                        var url = "customer/proses_hapus/"
                        $.ajax({
                                url: '<?= base_url() ?>' + url + id,
                                type: "POST",
                            })
                            .done(function(id) {
                                window.location.replace("<?= site_url("Customer") ?>");
